...
const detalle_entity_1 = require("src/entitys/detalle.entity");
let DetalleService = class DetalleService {
    ...
    getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.detalleRepository.find();
        });
    }
    crearDetalle(nuevoDetalle) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield typeorm_2.getConnection()
                .createQueryBuilder()
                .insert()
                .into(detalle_entity_1.Detalle)
                .values({
    ...
    crearDetalleBueno(crearDetalle) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(crearDetalle.idPedido);
            console.log(crearDetalle.idCarta);
            console.log(crearDetalle.cantidad);
            return yield typeorm_2.getConnection().createEntityManager().query(`select * from InsertarDetalle(${crearDetalle.idPedido}, ${crearDetalle.idCarta},${crearDetalle.cantidad})`);
        });
    }
};
